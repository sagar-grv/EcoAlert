            ...
            <div className="relative w-full max-w-[420px] glass-panel border-[2px] rounded-[2rem] overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex flex-col px-8 pt-14 pb-10">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm font-medium">Reporting for a Greener India</p>
                    </div>
                    ...
                    <p className="text-[10px] text-slate-500 font-medium text-center leading-relaxed mt-8 max-w-[280px] mx-auto">
