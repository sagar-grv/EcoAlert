            ...
            <div className="relative w-full max-w-[420px] bg-background-dark rounded-[2rem] overflow-hidden shadow-2xl border-[2px] border-white/10 flex flex-col">
                ...
                <div className="relative z-10 flex flex-col px-8 pt-14 pb-10">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <p className="text-slate-400 mt-2 text-sm font-medium">Reporting for a Greener India</p>
                    </div>
                    ...
                    >
                        <div className="text-center mb-2">
                            <h2 className="font-display text-2xl font-semibold text-slate-100">Welcome Back</h2>
                    ...
                    <p className="text-[10px] text-slate-500 text-center leading-relaxed mt-8 max-w-[280px] mx-auto">
                        By continuing, you agree to EcoAlert&apos;s Terms of Service. Environmental reports are verified by AI.
                    </p>
                </div>
            </div>
        </div>
